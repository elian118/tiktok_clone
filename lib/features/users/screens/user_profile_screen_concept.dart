...
// 슬리버 위젯의 기본 개념과 원리를 설명한 스크린 위젯 -> UserProfileScreen 대신 갈아끼면 확인 가능
class UserProfileScreenConcept extends StatefulWidget {
  const UserProfileScreenConcept({Key? key}) : super(key: key);

  @override
  State<UserProfileScreenConcept> createState() =>
      _UserProfileScreenConceptState();
}

class _UserProfileScreenConceptState extends State<UserProfileScreenConcept> {
  @override
