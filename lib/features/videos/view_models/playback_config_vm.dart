...
class PlaybackConfigViewModel extends Notifier<PlaybackConfigModel> {
  ...
  void setMuted(bool value) {
    ...
    // build() 리턴값이 get state{}에 담겨 전달 => state 재정의(setState)
...
final playbackConfigProvider =
  ...
  /* () => PlaybackConfigViewModel() // 원래대로라면 이렇게 키 랩퍼를 매개변수 없이 넣어야 한다.
     하지만, 이 키 랩퍼는 매개변수로 main.dart 에서만 호출 가능한 SharedPreferences 인스턴스 필요 */
  () =>
      throw UnimplementedError(), // 어쩔 수 없이, 여기서 예외 처리 후 main.dart 에서 오버라이드 위임
);
